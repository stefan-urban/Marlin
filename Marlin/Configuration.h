...
#define HOMING_FEEDRATE {1000, 1000, 400, 0}  // set the homing speeds (mm/min)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,579}  // default steps per unit for Ultimaker
